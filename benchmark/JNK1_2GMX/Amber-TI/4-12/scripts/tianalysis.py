...
# this script has been tested with pymbar v3.0.3
...
class FramesInThisTraj(object):
    ...
    def get_uncorrelated_indexes(self,tequil=0,state=None):
        ...
        idxs = np.array(pymbar.timeseries.subsample_correlated_data(dat,g=g))
        #print (len(idxs))
        return istart + idxs
    ...
    def get_statistical_inefficiency(self,tequil=0,tmax=1.e+10,state=None,with_data=False):
        ...
        if with_data:
            try:
                return pymbar.timeseries.statistical_inefficiency(dat),dat
            except Exception as e:
                print (e)
                return 1,dat
        else:
            try:
                return pymbar.timeseries.statistical_inefficiency(dat)
            except Exception as e:
                print (e)
                return 1
        ...
        if self.mbar:
            ...
            if ok:
                try:
                    ...
                    data = mbar.compute_free_energy_differences( uncertainty_method='svd-ew', return_theta = False )
                except Exception as e:
                ...
                Deltaf_ij = data['Delta_f']
                dDeltaf_ij = data['dDelta_f']
